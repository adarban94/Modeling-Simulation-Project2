...
for i=1:Nz
    for k=1:Nr 
        ...
        E_Rof(i,k)= Rof(i,k) - 0.001*(Pt*((C_C2H6(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))*Components(1).Mw + (C_C2H4(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))*Components(2).Mw + (C_O2(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))*Components(3).Mw + (C_CO2(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))*Components(4).Mw + (C_CO(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))*Components(5).Mw ...
            + (C_H2O(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))*Components(6).Mw + (C_N2(i,k)/(C_C2H6(i,k)+C_C2H4(i,k)+C_O2(i,k)+C_CO2(i,k)+C_CO(i,k)+C_H2O(i,k)+C_N2(i,k)))*Components(7).Mw))/(R*T(i,k)); % [kg/m^3] Density of fluid
        R=8.314e-3;                            % [(kJ/mol*K)]
        ...
        E_Cpf(i,k)= Cpf(i,k) - (((Components(1).cp_R(1) + Components(1).cp_R(2)*T(i,k) + Components(1).cp_R(3)*T(i,k)^2 + Components(1).cp_R(4)*T(i,k)^(-2))*R)*(y_gas(1)))*(1000/Components(1).Mw) ...
            - (((Components(2).cp_R(1) + Components(2).cp_R(2)*T(i,k) + Components(2).cp_R(3)*T(i,k)^2 + Components(2).cp_R(4)*T(i,k)^(-2))*R)*(y_gas(2)))*(1000/Components(2).Mw) ...
            - (((Components(3).cp_R(1) + Components(3).cp_R(2)*T(i,k) + Components(3).cp_R(3)*T(i,k)^2 + Components(3).cp_R(4)*T(i,k)^(-2))*R)*(y_gas(3)))*(1000/Components(3).Mw) ...
            - (((Components(4).cp_R(1) + Components(4).cp_R(2)*T(i,k) + Components(4).cp_R(3)*T(i,k)^2 + Components(4).cp_R(4)*T(i,k)^(-2))*R)*(y_gas(4)))*(1000/Components(4).Mw) ...
            - (((Components(5).cp_R(1) + Components(5).cp_R(2)*T(i,k) + Components(5).cp_R(3)*T(i,k)^2 + Components(5).cp_R(4)*T(i,k)^(-2))*R)*(y_gas(5)))*(1000/Components(5).Mw) ...
            - (((Components(6).cp_R(1) + Components(6).cp_R(2)*T(i,k) + Components(6).cp_R(3)*T(i,k)^2 + Components(6).cp_R(4)*T(i,k)^(-2))*R)*(y_gas(6)))*(1000/Components(6).Mw) ...
            - (((Components(7).cp_R(1) + Components(7).cp_R(2)*T(i,k) + Components(7).cp_R(3)*T(i,k)^2 + Components(7).cp_R(4)*T(i,k)^(-2))*R)*(y_gas(7)))*(1000/Components(7).Mw);
        
        E_T(i,k)= -u0*Rof(i,k)*Cpf(i,k)*Az(i+1,2:end-1)*T(:,k) - u0*Rof(i,k)*Cpf(i,k)*Az(i+1,1)*(u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)))/((1 + keffz*Az(end,1)*Az(1,end)/(Az(end,end)*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))) - u0*Rof(i,k)*Cpf(i,k)*Az(i+1,end)*(-Az(end,2:end-1)*T(:,k) - Az(end,1)*(u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)))/((1 + keffz*Az(end,1)*Az(1,end)/(Az(end,end)*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))))/Az(end,end)...
            + keffz*Bz(i+1,2:end-1)*T(:,k) + keffz*Bz(i+1,1)*(u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)))/((1 + keffz*Az(end,1)*Az(1,end)/(Az(end,end)*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))) + keffz*Bz(i+1,end)*(-Az(end,2:end-1)*T(:,k) - Az(end,1)*(u0*Rof(i,k)*Cpf(i,k)*T0 + keffz*Az(1,2:end-1)*T(:,k) + keffz*Az(1,end)/Az(end,end)*(-Az(end,2:end-1)*T(:,k)))/((1 + keffz*Az(end,1)*Az(1,end)/(Az(end,end)*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))))*(u0*Rof(i,k)*Cpf(i,k) - keffz*Az(1,1))))/Az(end,end) ...
